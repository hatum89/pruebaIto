...
export class UserService {
  ...
  listUser: UserInterface[] = [
    ...
    {user: 'Oscar.16', name: 'Oscar', secondName: 'Palmar', email: 'Oscar.12@gmail.com', available: true},
    {user: 'Melinda.27', name: 'Melinda', secondName: 'Rodriguez', email: 'Melinda.2@gmail.com', available: true},
    {user: 'Luis.43', name: 'Luis', secondName: 'Taco', email: 'Luis.4@gmail.com', available: true},
    {user: 'Lisa.565', name: 'Lisa', secondName: 'Simpsons', email: 'Lisa.56@gmail.com', available: true},
  ];
